...
fn rayColor(ray: ptr<function,Ray>) -> vec3<f32> {
    ...
    for (var step: u32 = 0; step < maxSteps; step++) {
        ...
        //This will store the index of the closest sphere.
        var i: i32 = 0;
...
fn distance_to_scene(ray: ptr<function,Ray>,
    sphere_index: ptr<function, i32>) -> f32 {

    var closest_distance: f32 = 9999;

    for (var i: i32 = 0; i < i32(scene.sphereCount); i++) {
        let distance: f32 = distance_to_sphere(ray, i);
